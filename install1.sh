...
echo -e "              (Version 1.3.5) - by: @RicOnly"
...
clear
fetch_valid_keys() {
keys=$(curl -s -H "Cache-Control: no-cache" -H "Pragma: no-cache" "https://raw.githubusercontent.com/osiafv/bhnbhn/main/hys.json")
echo "$keys"
}
verify_key() {
...
echo ""
figlet -k RicOnly | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1' && figlet -k Hysteria | awk '{gsub(/./,"\033[3"int(rand()*5+1)"m&\033[0m")}1'
echo "───────────────────────────────────────────────────────────────────────•"
echo ""
echo ""
...
echo -e "\033[1;32m      ♻️ \033[1;37m      \033[1;33mPlease wait...\033[0m"
echo -e ""
wget -O /etc/volt/cfgupt.py --no-cache 'https://raw.githubusercontent.com/osiafv/bhnbhn/main/cfgupt.py' &>/dev/null
...
clear
echo ""
figlet -k Ric-VPN | lolcat && figlet -k Hysteria | lolcat
echo -e "\e[1;34m************************************"
